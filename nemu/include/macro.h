 ...
 * IFZERO替换过程
 *IFZERO(0,fn)(1)
 *MUXZERO(0, __KEEP, __IGNORE)(fn)(1)
 *MUX_MACRO_PROPERTY(__P_ZERO_,0, __KEEP, __IGNORE)(fn)(1);
 *MUX_MACRO_PROPERTY(__P_ZERO_,0, __KEEP, __IGNORE)(fn)(1);
 *MUX_WITH_COMMA(X,, __KEEP, __IGNORE)(fn)(1);
 *CHOOSE2nd(X, __KEEP, __IGNORE)(fn)(1);
 * __KEEP(fn)(1)
 * fn(1)
 *
 *IFZERO(1,fn)(1)
 *MUXZERO(1, __KEEP, __IGNORE)(fn)(1)
 *MUX_MACRO_PROPERTY(__P_ZERO_,1, __KEEP, __IGNORE)(fn)(1);
 *MUX_MACRO_PROPERTY(__P_ZERO_,1, __KEEP, __IGNORE)(fn)(1);
 *MUX_WITH_COMMA(__P_ZERO_1, __KEEP, __IGNORE)(fn)(1);
 *CHOOSE2nd(__P_ZERO_1 __KEEP, __IGNORE)(fn)(1);
 *__IGNORE(fn)(1)
 *(1)
**/
